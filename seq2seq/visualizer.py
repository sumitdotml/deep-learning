...
class LossVisualizer:
    ...
    def __init__(self, save_dir: str = "plots"):
        ...
        print(f"Loss visualization initialized. Plots will be saved to: {save_dir}/")
    ...
    def save_final_plot(self, best_val_loss: float):
        ...
        if len(self.train_losses) > 0:
            ...
            print(
                f"   Train Improvement: {self.train_losses[0] - self.train_losses[-1]:.4f}"
            )
            print(f"   Initial Val Loss: {self.val_losses[0]:.4f}")
            print(f"   Best Val Loss: {best_val_loss:.4f}")
            print(f"   Val Improvement: {self.val_losses[0] - best_val_loss:.4f}")
